...
Gui, Add, Text,, • Ctrl + Shift + S - Open GPT with Input
...
Gui, Add, Text,, • Ctrl + Shift + L - Ask GPT for current song
Gui, Add, Text,, • Alt + F11 - Prev Song
Gui, Add, Text,, • Alt + F12 - Next Song
Gui, Add, Text,, • W + ' - Ask Spotify 
Gui, Add, Text,, ------

Gui, Add, Text,, • Ctrl + Shift + W - Send Message to Whatsapp from Clipboard
